Red [
	title:   "VK_ keycode set"
	author:  @hiiamboris
	license: 'BSD-3
]


vkeys: make block! 200		;-- right now they're 192

;; direct paste from VS 2017
parse {
/*
...
|	"//" to lf
|	"#define" some [sp | tab]
	copy name ["VK_" to [sp | tab]] some [sp | tab]
	"0x" copy hex to [sp | tab | lf]
	(set load name load rejoin [hex "h"])
	(append vkeys load name)
|	skip
]]
